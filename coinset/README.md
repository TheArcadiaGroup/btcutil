...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/TheArcadiaGroup/firoutil/coinset)
...
```bash
$ go get -u github.com/TheArcadiaGroup/firoutil/coinset
```
